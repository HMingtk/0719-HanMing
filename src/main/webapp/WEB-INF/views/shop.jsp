							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<h2>${p.price}</h2>
										<p>${p.productName}</p>
										<a href="<%=basePath%>cart?productId=${p.productId}&action=add" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart">Add to cart</i></a>
									</div>
								</div>
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										<li><a href="<%=basePath%>productDetails?id=${p.productId}"><i class="fa fa-plus-square">Product-Details</i></a></li>
									</ul>
								</div>
							</div>
						</div>
