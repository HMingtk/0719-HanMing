            ...
            <table class="table table-condensed">
                ...
                <c:forEach var="o" items="${orderList}">
                    <tr>
                        ...
                        <td>${o.orderDate}</td>
                        <%
                            com.hanming.model.Order o = (com.hanming.model.Order) pageContext.findAttribute("o");
                            int userId = o.getCustomerId();
                            java.sql.Connection con = (java.sql.Connection) application.getAttribute("con");
                            com.hanming.dao.UserDao userDao = new com.hanming.dao.UserDao();
                        ...
                        <td class="cart_total">${o.paymentId}
                            <%
                                ...
                                String paymentType = com.hanming.model.Payment.findByPaymentId(con, n);
                            %>
